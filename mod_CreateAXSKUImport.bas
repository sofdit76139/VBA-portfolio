Attribute VB_Name = "mod_CreateAXSKUImport"
Option Explicit
...
'**************************************************************************************************************
    ...
    csPath = "C:\Users\" & strUserName & "\OneDrive - COMPANY\Merchandising Documents\AX Imports\Execute\"
...
'check if the workbook is already open; if not, open it
    ...
    If lRw = 0 Then
        ...
        MsgBox "No delimiter 'X' was found. Please check column A. This script will now exit.", vbCritical, "Information Missing!"
    ...
    For Each cl In ws.Range("A1:A" & lRw)
            ...
            'loop only through the empty cells until you find one that fits the criteria
                ...
                If IsEmpty(cl) And cl.Interior.Color = RGB(248, 203, 173) Then
                        ...
                        ElseIf IsEmpty(cl.Offset(0, 19)) And Not cl.Offset(0, 19).Value = "0" Then ' cost/purchase price
                        ...
                        ElseIf IsEmpty(cl.Offset(0, 20)) And Not cl.Offset(0, 20).Value = "0" Then  ' standard cost
                        ...
                        ElseIf IsEmpty(cl.Offset(0, 24)) And Not cl.Offset(0, 24).Value = "0" Then ' retail price
...
'**************************************************************************************************************
            ...
            csPath = "C:\Users\" & strUserName & "\OneDrive - COMPANY\Merchandising Documents\AX Imports\New SKUs\Execute\"
                ...
                For Each cl In rngEval
                    ...
                    If cl.Value = vendorID And cl.Offset(0, -17).Value = "" And cl.Offset(0, -17).Interior.Color = RGB(248, 203, 173) Then 'copy only from rows where the first cell is blank and the vendor ID matches what we have previously found
                        ...
                        If IsEmpty(currentRowValue) Or currentRowValue = "" Then
                            ...
                            ws2.Cells(currentRow, sourceCol).Value = cl.Offset(0, 24).Value ' copy over the bar code
                            ws2.Cells(currentRow, sourceCol).Offset(0, 1).NumberFormat = "@"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 1).Value = cl.Offset(0, 14).Value ' copy over the external item ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 2).Value = "0"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 4).Value = cl.Offset(0, -3).Value ' copy over the unit ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 5).Value = "0"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 8).Value = "0"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 10).Value = "AllBlank"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 11).Value = cl.Offset(0, 2).Value ' copy over the purchase price
                            ws2.Cells(currentRow, sourceCol).Offset(0, 12).Value = "USD"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 13).Value = vendorID ' copy over the vendor ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 15).Value = Format(Now, "MM/DD/YYYY") ' use today's date as "from" date
                            ws2.Cells(currentRow, sourceCol).Offset(0, 17).Value = "2" ' Module 2 is for purchase price
                ...
                For Each cl In rngEval
                    ...
                    If cl.Value = vendorID And cl.Offset(0, -17).Value = "" And cl.Offset(0, -17).Interior.Color = RGB(248, 203, 173) Then 'copy only from rows where the first cell is blank and the vendor ID matches what we have previously found
                        ...
                        If IsEmpty(currentRowValue) Or currentRowValue = "" Then
                            ...
                            ws2.Cells(currentRow, sourceCol).Offset(0, 1).NumberFormat = "@"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 1).Value = cl.Offset(0, 14).Value ' external item ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 2).Value = cl.Offset(0, 36).Value ' KID Min. Qty in Stock
                            ws2.Cells(currentRow, sourceCol).Offset(0, 3).Value = cl.Offset(0, 37).Value ' KID Max. Qty in Stock
                            ws2.Cells(currentRow, sourceCol).Offset(0, 4).Value = cl.Offset(0, 32).Value ' KID Coverage Group
                            ws2.Cells(currentRow, sourceCol).Offset(0, 5).Value = cl.Offset(0, 13).Value ' Forecast Item Group
                            ws2.Cells(currentRow, sourceCol).Offset(0, 6).Value = cl.Offset(0, 22).Value ' KID Lead Time
                            ws2.Cells(currentRow, sourceCol).Offset(0, 7).Value = cl.Offset(0, 16).Value ' Case/Pack Qty
                            ws2.Cells(currentRow, sourceCol).Offset(0, 8).Value = cl.Offset(0, 17).Value ' Minimum Order Qty
                            ws2.Cells(currentRow, sourceCol).Offset(0, 9).Value = cl.Offset(0, 60).Value ' KID Order Qty
                            ws2.Cells(currentRow, sourceCol).Offset(0, 10).Value = cl.Offset(0, 50).Value ' Season Code
                            ws2.Cells(currentRow, sourceCol).Offset(0, 11).Value = cl.Offset(0, 28).Value ' DAL Coverage Group
                            ws2.Cells(currentRow, sourceCol).Offset(0, 12).Value = cl.Offset(0, 61).Value ' DAL Order Qty
                            ws2.Cells(currentRow, sourceCol).Offset(0, 13).Value = cl.Offset(0, 27).Value ' DAL Transfer From
                            ws2.Cells(currentRow, sourceCol).Offset(0, 14).Value = cl.Offset(0, -4).Value ' Inventory Unit
                            ws2.Cells(currentRow, sourceCol).Offset(0, 15).Value = cl.Offset(0, -3).Value ' Purchase Unit
                            ws2.Cells(currentRow, sourceCol).Offset(0, 16).Value = cl.Offset(0, -2).Value ' Selling Unit
                            ws2.Cells(currentRow, sourceCol).Offset(0, 17).Value = cl.Offset(0, 56).Value ' Special Cost
                            ws2.Cells(currentRow, sourceCol).Offset(0, 18).Value = cl.Offset(0, 2).Value ' Cost
                            ws2.Cells(currentRow, sourceCol).Offset(0, 19).Value = cl.Offset(0, 62).Value ' Extended Cost
                            ws2.Cells(currentRow, sourceCol).Offset(0, 20).Value = cl.Offset(0, 7).Value ' Retail
                            ws2.Cells(currentRow, sourceCol).Offset(0, 21).Value = cl.Offset(0, 47).Value ' MAP Price
                            ws2.Cells(currentRow, sourceCol).Offset(0, 22).Value = cl.Offset(0, 54).Value ' MarketPlace Banned
                            ws2.Cells(currentRow, sourceCol).Offset(0, 23).Value = cl.Offset(0, -1).Value ' Buyer #
                            ws2.Cells(currentRow, sourceCol).Offset(0, 24).Value = vendorID ' Vendor ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 25).Value = cl.Offset(0, 1).Value ' Vendor Name
                            ws2.Cells(currentRow, sourceCol).Offset(0, 26).NumberFormat = "@"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 26).Value = cl.Offset(0, 24).Value ' BarCode
                            ws2.Cells(currentRow, sourceCol).Offset(0, 27).NumberFormat = "@"
                            ws2.Cells(currentRow, sourceCol).Offset(0, 27).Value = cl.Offset(0, 25).Value ' BarCode setup ID
                            ws2.Cells(currentRow, sourceCol).Offset(0, 28).Value = cl.Offset(0, 63).Value ' Receipt Date
                            ws2.Cells(currentRow, sourceCol).Offset(0, 29).Value = cl.Offset(0, 64).Value ' Cancel Date
                            ws2.Cells(currentRow, sourceCol).Offset(0, 30).Value = cl.Offset(0, 65).Value ' Comments
                            ws2.Cells(currentRow, sourceCol).Offset(0, 31).Value = cl.Offset(0, 66).Value ' First PO#
