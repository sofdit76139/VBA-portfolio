Attribute VB_Name = "mod_ExportPriceList"
Sub ExportPriceList()
' Exports the price list information from the Price-Desc-Cat-Prop65 sheet to a separate workbook
...
On Error Resume Next
    ...
    MyWkSh = Worksheets("Vendor Info").Range("B2").Value & " Price List Import"
...
'    MsgBox "The import file was generated for batch upload."
    ...
    Worksheets("CommandCentral").Cells(13, 2).Value = Format(Now, "mm/dd/yyyy")
    Worksheets("CommandCentral").Cells(14, 2).Value = Format(Now, "hh:mm ampm")
