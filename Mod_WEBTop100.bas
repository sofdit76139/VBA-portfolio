Attribute VB_Name = "Mod_WEBTop100"
Sub MyPivotCopyFormatValues4()
'select pivot table cell first

' run for the top profit on website
...
For Each ws In ThisWorkbook.Worksheets
    If ws.Name Like "* WEB Top 100" Then
...
ActiveSheet.Name = Format(Now, "YYYY_MM_DD") & " WEB Top 100"
...
ActiveSheet.Range("K1").Cells.Value = "WebPrice"

ActiveSheet.Range("L1").Cells.Value = "WebMargin"
...
With ws
    ...
    For i = 1 To lRw Step 3
        ...
        .Hyperlinks.Add Anchor:=ActiveCell, Address:="https://COMPANY.com/search?w=" & ActiveCell.Text, TextToDisplay:=ActiveCell.Text
...
With ws
    ...
    Range("K2:K" & lRw).Formula = "=IFNA(VLOOKUP($A2,SalesBasic,16,false)," & Chr(34) & Chr(34) & ")"
    Range("K2:K" & lRw).NumberFormat = "_($* #,##0.00_)"
    
    Range("L2:L" & lRw).Formula = "=IFNA(VLOOKUP($A2,SalesBasic,18,false)," & Chr(34) & Chr(34) & ")"
...
ActiveSheet.Range("M1").Cells.Value = "CheckForRelated"
