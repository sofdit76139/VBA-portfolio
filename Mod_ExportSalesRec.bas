Attribute VB_Name = "Mod_ExportSalesRec"
Sub MyExportSalesRecommendation()

' run to export sales recommendations
...
For Each ws In ThisWorkbook.Worksheets
    If ws.Name Like "* Sales Rec" Then
    
        MyWkSh = ws.Name
        
        MyWkb = MyWkSh & "_" & Format(Now, "HHMMSS") & ".xlsx"

        csPath = "C:\Users\Sofie.Dittmann\OneDrive - COMPANY\Reporting\Merchandising" & "\SalesRec\"
...
ActiveSheet.Name = Format(Now, "YYYY_MM_DD") & " Sales Rec"

Set ws = ActiveSheet

For Each Row In Range("PutOnSale[#All]").Rows
