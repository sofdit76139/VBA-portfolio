Attribute VB_Name = "CopyPivotTable"
Sub CopyPivotTable()
...
For Each ws In ThisWorkbook.Worksheets
    If ws.Name Like "* SalesHistory" Then
    
        MyWkSh = ws.Name
        
        MyWkb = MyWkSh & "_" & Format(Now, "HHMMSS") & ".xlsx"

        csPath = "C:\Users\Sofie.Dittmann\OneDrive - Lehman's\Reporting\Merchandising" & "\Seasonal\"
...
ActiveSheet.Name = Format(Now, "YYYY_MM_DD") & " SalesHistory"
