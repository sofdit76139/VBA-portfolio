Attribute VB_Name = "mod_ExportManufacturer"
Sub ExportManufacturer()
' Exports the manufacturer information from the Price-Desc-Cat-Prop65 sheet to a separate text file
...
On Error Resume Next
    ...
    MyWkSh = Worksheets("Vendor Info").Range("B2").Value & " Manufacturer CV3 Import"
    ...
    With ActiveWorkbook
        ...
        ActiveSheet.Range("B1").Value = "Brand"
        ActiveSheet.Range("C1").Value = "Manufacturer"
...
'    MsgBox "The import file was generated for batch upload."
    ...
    Worksheets("CommandCentral").Cells(13, 17).Value = Format(Now, "mm/dd/yyyy")
    Worksheets("CommandCentral").Cells(14, 17).Value = Format(Now, "hh:mm ampm")
